...
import accessoreHero from "../components/IMG/accessoreHero.png"; // Assuming this is the correct path for the hero image
  ...
  return (
    <>
      <section className="relative w-full h-[45vh] md:h-[52vh] flex items-center justify-center overflow-hidden">
        <motion.img src={accessoreHero} alt="Shop For Accessories" className="absolute inset-0 w-full h-full object-cover object-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2 }} />
...
export default ShopForAccessories;
