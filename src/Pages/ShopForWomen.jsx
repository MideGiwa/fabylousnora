  ...
  return (
    <>
      <section className="relative w-full h-[45vh] md:h-[52vh] flex items-center justify-center overflow-hidden">
        <motion.img src={womenHero} alt="Shop For Women" className="absolute inset-0 w-full h-full object-cover  " style={{ objectPosition: "0 -110px" }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2 }} />
