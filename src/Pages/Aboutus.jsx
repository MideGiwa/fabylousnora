...
function Aboutus() {
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Founder Section - FIXED WITH FLEXBOX */}
      <section className="px-[6%] my-12 md:my-16">
        <div className="max-w-7xl mx-auto">
          {/* IMPORTANT FIX: Replaced grid with flex for responsive side-by-side layout */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12"> 

            {/* Image - Now responsive w-1/2, h-auto */}
          <motion.div
          initial={{ opacity: 0, x: -40 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="flex justify-center md:justify-end h-full w-full md:w-1/2 mt-8 md:mt-0" // Added md:w-1/2
        >
          {/* Removed fixed px dimensions and ensured max-height for image control */}
          <div className="overflow-hidden h-full w-full bg-transparent max-h-[500px]">
            ...
            />
             ...
             {/* Text - Now responsive w-1/2, removed fixed height */}
           <motion.div
    initial={{ opacity: 0, x: 40 }}
    whileInView={{ opacity: 1, x: 0 }}
    viewport={{ once: true }}
...
>            <h2
    ...
    >
      ...
      {/* Pink Container Section with Content */}
  <section className="px-[6%] my-12 md:my-16">
  <div className="max-w-7xl mx-auto">
    <div className="h-[200px] bg-[#BD007C] rounded-lg shadow-md flex items-center px-8 md:px-26">
      <p className="text-white text-2xl md:text-[24px] leading-none font-['Playfair_Display'] italic tracking-wide">
      ...
      {/* About Us Section (Already fixed) */}
